export const fr = {
  about: "À propos",
  aboutDescription:
    "Cette application est une ressource pour informer les serviteurs de confiance d'A.A. sur ce qui se passe dans leur district, leur région et au Bureau de service général.",
  aboutDownload: "Téléchargez l'application Meeting Guide",
  aboutLogin:
    "Les responsables de région et de district doivent se connecter à generalservice.app pour mettre à jour les informations.",
  ...
  districtNumberNmae: "{{number}}: {{name}}",
  districtNotFound:
  ...
  news: "Nouvelles",
  notParticipatingTitle:
    "Cet {{entity}} ne participe pas encore à l'application",
  notParticipatingDescription:
    "Nous intégrons les régions une par une. Nous contacterons votre délégué de région dans les semaines à venir pour évaluer l'intérêt de participer.",
