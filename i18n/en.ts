export const en = {
  about: "About",
  aboutDescription:
    "This app is a resource to inform trusted servants in A.A. about what is happening in their District, Area, and at the General Service Office.",
  aboutDownload: "Download the Meeting Guide app",
  aboutLogin:
    "Area and district officers should log in to generalservice.app to update information.",
  ...
  locating: "Locating…",
  news: "News",
  notParticipatingTitle: "This {{entity}} is not partipating in the app yet",
  notParticipatingDescription:
    "We are onboarding areas one at a time. We'll be reaching out to your Area Delegate in the coming weeks to gauge interest in participation.",
  resources: "Resources",
  share: "Share",
  success: "Success",
